import 'dart:io';
import 'prerender/prerender_service.dart';
import 'seo/seo_optimizer.dart';
...
class FluserServer {
  ...
  Future<void> _serveAboutPage(HttpRequest request) async {
    _seoOptimizer.generateMetaTags('About Fluser',
        'Learn more about the Fluser framework.', 'Fluser, about, framework');
    request.response
      ..statusCode = HttpStatus.ok
